...
class MainMenu:
    ...
    def start_music(self):
        ...
        self.window.music.play(pygame.mixer.Sound(path.join(DATA_PATH, SOUND_PATH, 'start_screen.wav')), loops=-1)
        self.window.music.set_volume(SOUND_LEVEL)

    def _init_image(self):
        self.background_image = pygame.image.load(path.join(DATA_PATH, IMAGE_PATH, BACKGROUND_PATH, 'cybercity.jpg'))
        self.background_image = pygame.transform.scale(self.background_image, WINDOW_SIZE)
        self.fading_image = pygame.image.load(path.join(DATA_PATH, IMAGE_PATH, BACKGROUND_PATH, 'fading.png'))
        self.fading_image = pygame.transform.scale(self.fading_image, WINDOW_SIZE)
    ...
    def _init_text(self):
        ...
        self.subtitle_font = pygame.font.Font(pygame.font.match_font('lucidaconsole'), 24)
    ...
    def _draw_text(self):
        string_title = self.title_font.render(self.intro_text[0], True, pygame.Color('white'))
        string_subtitle = self.subtitle_font.render(self.intro_text[1], True, pygame.Color('white'))
